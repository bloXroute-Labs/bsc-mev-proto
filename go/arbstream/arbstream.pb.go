...
type Order struct {
	...
	BackrunmeRewardAddress string                  `protobuf:"bytes,10,opt,name=backrunme_reward_address,json=backrunmeRewardAddress,proto3" json:"backrunme_reward_address,omitempty"`
...
func (x *Order) GetBackrunmeRewardAddress() string {
	if x != nil {
...
const file_arbstream_proto_rawDesc = "" +
	"\n" +
	"\x0farbstream.proto\x12\tarbstream\"\x80\x04\n" +
	"\x05Order\x12:\n" +
	...
	"\x10max_block_number\x18\t \x01(\x04R\x0emaxBlockNumber\x128\n" +
	"\x18backrunme_reward_address\x18\n" +
	" \x01(\tR\x16backrunmeRewardAddress\x1aP\n" +
	"\n" +
	"StateEntry\x12\x10\n" +
