...
type Order struct {
	...
	BackrunmeRewardAddress string                  `protobuf:"bytes,10,opt,name=backrunmeRewardAddress,proto3" json:"backrunmeRewardAddress,omitempty"`
...
const file_arbstream_proto_rawDesc = "" +
	"\n" +
	"\x0farbstream.proto\x12\tarbstream\"\xfe\x03\n" +
	"\x05Order\x12:\n" +
	...
	"\x10max_block_number\x18\t \x01(\x04R\x0emaxBlockNumber\x126\n" +
	"\x16backrunmeRewardAddress\x18\n" +
